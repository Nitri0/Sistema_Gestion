                    ...
                    <div class="panel panel-inverse overflow-hidden custon-list" ng-repeat="usuario in usuarios| filter:opciones.buscador | orderBy:sort:reverse  track by $index">
                        <div class="panel-heading">
                            ...
                            <div class="box-button-list">
                            	...
                            	<a ng-if="habilitado_usuario = 1" class="btn btn-sm btn-danger btn-cirule" ng-href="{{ url( '/admin_usuarios/[[usuario.id_usuario]]/destroy' ) }}" data-toggle="tooltip" data-title="Deshabilitar"><i class="fa fa-thumbs-o-down"></i></a>
                            	<a ng-if="habilitado_usuario = 0" class="btn btn-sm btn-success btn-cirule" ng-href="{{ url( '/admin_usuarios/[[usuario.id_usuario]]/habilitar' ) }}" data-toggle="tooltip" data-title="Habilitar"><i class="fa fa-thumbs-o-up"></i></a>
                            </div>
                            <h3 class="panel-title list-title">
                                <div class="row">
                                    <div class="col-sm-3"> 
